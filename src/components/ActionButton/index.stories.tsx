...
NoConfirmRequired.test('click handler called on click', async ({ args, canvas, userEvent }) => {
...
export const WithConfirmRequiredOpen = meta.story({
  args: {
    requireConfirm: true,
  },
  play: async ({ args, canvas, userEvent }) => {
    ...
    await expect(await screen.findByText('Confirm')).toBeInTheDocument();
  },
});

WithConfirmRequiredOpen.test('clicking confirm calls click handler', async ({ args, userEvent }) => {
...
export const WithCustomMessageOpen = meta.story({
  args: {
